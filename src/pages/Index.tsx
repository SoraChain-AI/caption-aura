...
const Index = () => {
          ...
          <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
              >
                <Card className="glass-card hover:glass-strong transition-all duration-300 cursor-pointer h-full"
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button
              ...
              onClick={() => setCurrentMode('train')}
              className={currentMode === 'train' ? 'bg-gradient-primary' : 'glass-card'}
            >
            ...
            <Button
              ...
              onClick={() => setCurrentMode('inference')}
              className={currentMode === 'inference' ? 'bg-gradient-ai' : 'glass-card'}
            >
      ...
      <div className="fixed bottom-20 right-10 w-40 h-40 bg-gradient-ai rounded-full blur-3xl opacity-20 animate-float" style={{ animationDelay: '2s' }}></div>
    </div>
  );
};
